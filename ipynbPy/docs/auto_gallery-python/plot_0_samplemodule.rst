...
.. "auto_gallery-python/plot_0_samplemodule.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_gallery-python_plot_0_samplemodule.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_gallery-python_plot_0_samplemodule.py:
...
.. _sphx_glr_download_auto_gallery-python_plot_0_samplemodule.py:
